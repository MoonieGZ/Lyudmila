    ...
    public class FileSystemRouteHandler
    {
        ...
        private static HttpResponse Handle_LocalFile(HttpRequest request, string local_path)
        {
            ...
            var response = new HttpResponse
            {
                StatusCode = "200",
                ReasonPhrase = "Ok",
                Headers = {["Content-Type"] = QuickMimeTypeMapper.GetMimeType(file_extension)},
                Content = File.ReadAllBytes(local_path)
            };
        ...
        private static HttpResponse Handle_LocalDir(HttpRequest request, string local_path)
        {
            ...
            return new HttpResponse {StatusCode = "200", ReasonPhrase = "Ok", ContentAsUTF8 = output.ToString()};
        }
    }
